...
namespace electro_shop_backend.Services
{
    public class FilterService : IFilterService
    {
        ...
        public async Task<List<ProductCardDto>> FilterProductsInCategoryAsync(
        int categoryId,
        ...
        public async Task<List<ProductCardDto>> FilterProductsInBrandAsync(
            int brandId,
            int? priceFilter = null,
            int? categoryId = null,
            int? ratingFilter = null)
        {
            ...
            {
                products = products.Where(p => p.Categories != null && p.Categories.Any(c=>c.CategoryId ==categoryId.Value)).ToList();
            }
            double? minRating = null;
            double? maxRating = null;
            if (ratingFilter.HasValue)
