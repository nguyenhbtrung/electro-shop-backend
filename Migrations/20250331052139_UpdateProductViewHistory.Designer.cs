...
namespace electro_shop_backend.Migrations
{
    ...
    [Migration("20250331052139_UpdateProductViewHistory")]
    partial class UpdateProductViewHistory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("electro_shop_backend.Models.Entities.ProductViewHistory", b =>
                {
                    ...
                    b.HasIndex("UserId", "ProductId")
                        .IsUnique()
                        .HasFilter("[user_id] IS NOT NULL AND [product_id] IS NOT NULL");
            ...
            modelBuilder.Entity("electro_shop_backend.Models.Entities.ReturnHistory", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ReturnHistoryId"));
